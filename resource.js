/**
 * @exports file for the pencil shop node.js application
 * @author Aidan Reilly 
 */

/**
 * qs is used to parse the queires generated by the application. 
 * @module qs
 */
var qs = require('querystring');

/**
 * fs is used to serve files in the application. 
 * @module fs
 */
var fs = require('fs');
 ...
 * @function actionForm
 * @param id, path, label name person/thing you want to say hello to.
 * @returns html Hello + name 
 */
...
/*
 * remove allows items to be removed from stock. 
 * @function remove
 */
